...
<div class="menu-wrap">
  <nav class="menu">
    <ul>
      ...
      <li><a class="normal" href="CubedOS.php">CubedOS </a></li>
      ...
      <li class="tab">
        <a class="newdropdown" onmouseenter="mouseEnterResources()"
           onclick="toggle('ResourcesDropdown', 'drop3')">Resources</a>
        <button class="navbar" aria-haspopup="true" aria-expanded="false" id="drop3"
                onclick="toggle('ResourcesDropdown', 'drop3')">&#9660;
        </button>
        <ul class="sub-menu" onmouseleave="mouseLeaveResources()" style="display: none"
            id="ResourcesDropdown">
          <li><a href="doc/CubedOS.pdf" target="_blank">Main Documentation</a></li>
          <li><a href="/CubedOS/src/check/build/gnatdoc/index.html" target="_blank">CubedOS
              API</a></li>
          <li><a href="/CubedOS/mercury/target/scala-3.4.2/api/index.html" target="_blank">Mercury
              API</a></li>
        </ul>
      </li>
